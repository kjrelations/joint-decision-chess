...
def handle_piece_move(game, selected_piece, row, col):
    ...
    if not is_check(temp_board, is_white): # redundant now? Not for premoves
...
async def main():
    ...
    while init["running"]:
        ...
        if web_game_metadata_dict['whites_turn'] != client_game.whites_turn:
            web_game_metadata_dict['whites_turn'] = client_game.whites_turn
