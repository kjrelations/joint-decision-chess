...
async def main():
    ...
    while init["running"]:
        ...
        try:
            if ((client_game.white_played and client_game._starting_player) \
               or (client_game.black_played and not client_game._starting_player) or \
               not client_game._sync) and not client_game.end_position:
